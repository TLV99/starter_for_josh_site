      ...
      <section class="container-fluid articlebg">
          ...
          <div class="row">
              ...
              <div class="col-md-4 article-cent">
                  <img class="img-responsive" alt=“portait” src="http://206.189.45.97/~mesh18/wp-content/themes/starter_for_josh_site/images/portrait.jpg">
                  <h4> A PORTRAIT</h4>
               ...
               <div class="col-md-4 article-cent">
                   <img class="img-responsive" alt=“portait” src="http://206.189.45.97/~mesh18/wp-content/themes/starter_for_josh_site/images/model.jpg">
                  <h4> A MODEL</h4>
                     <p class="date"> 12 December 2020</p>
                  <p>STS has never been shy of seeking new terrains of  investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session.   We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts. 
                  </p>
               ...
               <div class="col-md-4 article-cent">
                   <img class="img-responsive" alt=“portait” src="http://206.189.45.97/~mesh18/wp-content/themes/starter_for_josh_site/images/games.jpg">
                  <h4> GAMES DESIGN</h4>
   <p class="date"> 12 December 2020</p>
